...
class RobotNewsStationNode(Node): #MODIFY NAME
    def __init__(self):
        ...
        self.get_logger().info("Robot News Station has been started") #Bu satırın çalışması demek bundan önceki satırların çalışmış olması demektir. Bundan dolayı bu satırın çalışması önemlidir.
